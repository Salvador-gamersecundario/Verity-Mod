...
import net.minecraft.client.renderer.ShaderInstance.DummyUniform;
...
public class SphereRenderer {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation("verity", "textures/entity/verity_sphere.png");
